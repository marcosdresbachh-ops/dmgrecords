  ...
  <div class="ptab-panel active" id="cfg-geral">
    <div class="g2">
      ...
      <div class="card"><div class="card-hdr"><div class="card-title">Redes Sociais</div></div><div class="card-body">
        <div class="fg"><label class="fl">Instagram</label><input class="fi" id="cfg-ig" value="@dmgrecordsradio" placeholder="@usuario"></div>
        <div class="fg"><label class="fl">Facebook</label><input class="fi" id="cfg-fb" value="fb.com/dmgrecords" placeholder="URL da página"></div>
        <div class="fg"><label class="fl">YouTube</label><input class="fi" id="cfg-yt" value="" placeholder="URL do canal"></div>
        <div class="fg"><label class="fl">WhatsApp (pedidos)</label><input class="fi" id="cfg-wa" value="+55 (62) 99999-0000"></div>
...
const SCHEDULE = {
  seg:[ {time:'06:00–09:00',show:'Bom Dia DMG',host:'DJ Marcos',genre:'Sertanejo',type:'Ao Vivo',status:'ativo'}, {time:'09:00–12:00',show:'Morning Hits',host:'DJ Letícia',genre:'Pop / R&B',type:'Ao Vivo',status:'ativo'}, {time:'12:00–15:00',show:'Almoço Sertanejo',host:'DJ Carlos',genre:'Sertanejo',type:'Ao Vivo',status:'live'}, {time:'15:00–18:00',show:'Tarde Gospel',host:'DJ Ana Lima',genre:'Gospel',type:'Ao Vivo',status:'ativo'}, {time:'18:00–21:00',show:'Prime Time DMG',host:'DJ Rafael',genre:'Pop / Rock',type:'Ao Vivo',status:'ativo'}, {time:'21:00–00:00',show:'Noite Romântica',host:'DJ Sandra',genre:'Sertanejo',type:'Ao Vivo',status:'ativo'}, {time:'00:00–06:00',show:'Madrugada DMG',host:'AutoDJ',genre:'Variado',type:'Auto',status:'ativo'}, ],
  ter:[ {time:'06:00–09:00',show:'Rock na Manhã',host:'DJ André',genre:'Rock',type:'Ao Vivo',status:'ativo'}, {time:'09:00–12:00',show:'Gospel Matinal',host:'DJ Ana Lima',genre:'Gospel',type:'Ao Vivo',status:'ativo'}, {time:'12:00–15:00',show:'Almoço Sertanejo',host:'DJ Carlos',genre:'Sertanejo',type:'Ao Vivo',status:'ativo'}, {time:'15:00–21:00',show:'Pop & R&B',host:'DJ Letícia',genre:'Pop/R&B',type:'Ao Vivo',status:'ativo'}, {time:'21:00–06:00',show:'Madrugada DMG',host:'AutoDJ',genre:'Variado',type:'Auto',status:'ativo'}, ],
  qua:[{time:'06:00–12:00',show:'Manhã Gospel',host:'DJ Ana Lima',genre:'Gospel',type:'Ao Vivo',status:'ativo'},{time:'12:00–18:00',show:'Tarde Sertaneja',host:'DJ Carlos',genre:'Sertanejo',type:'Ao Vivo',status:'ativo'},{time:'18:00–00:00',show:'Noite Pop',host:'DJ Marcos',genre:'Pop/R&B',type:'Ao Vivo',status:'ativo'},{time:'00:00–06:00',show:'Madrugada DMG',host:'AutoDJ',genre:'Variado',type:'Auto',status:'ativo'}],
  qui:[{time:'06:00–09:00',show:'Bom Dia DMG',host:'DJ Marcos',genre:'Sertanejo',type:'Ao Vivo',status:'ativo'},{time:'09:00–15:00',show:'Morning Gospel',host:'DJ Ana Lima',genre:'Gospel',type:'Ao Vivo',status:'ativo'},{time:'15:00–21:00',show:'Rock & Pop',host:'DJ André',genre:'Rock/Pop',type:'Ao Vivo',status:'ativo'},{time:'21:00–06:00',show:'Madrugada DMG',host:'AutoDJ',genre:'Variado',type:'Auto',status:'ativo'}],
  sex:[{time:'06:00–12:00',show:'Sexta Animada',host:'DJ Rafael',genre:'Pop/R&B',type:'Ao Vivo',status:'ativo'},{time:'12:00–18:00',show:'Sertanejo de Raiz',host:'DJ Carlos',genre:'Sertanejo',type:'Ao Vivo',status:'ativo'},{time:'18:00–22:00',show:'Gospel da Sexta',host:'DJ Ana Lima',genre:'Gospel',type:'Ao Vivo',status:'ativo'},{time:'22:00–06:00',show:'Rock Night',host:'DJ André',genre:'Rock',type:'Ao Vivo',status:'ativo'}],
  sab:[{time:'08:00–12:00',show:'Sábado Gospel',host:'DJ Ana Lima',genre:'Gospel',type:'Ao Vivo',status:'ativo'},{time:'12:00–16:00',show:'Churrasco Sertanejo',host:'DJ Carlos',genre:'Sertanejo',type:'Ao Vivo',status:'ativo'},{time:'16:00–20:00',show:'Pop Hits Weekend',host:'DJ Letícia',genre:'Pop',type:'Ao Vivo',status:'ativo'},{time:'20:00–06:00',show:'Rock Weekend',host:'DJ André',genre:'Rock',type:'Ao Vivo',status:'ativo'}],
...
function buildTodaySchedule(){
  ...
  el.innerHTML = sched.map(s=>\`
    <div class="tl-item \${s.status==='live'?'tl-now':''}">
      <div class="tl-time \${s.status==='live'?'style="color:var(--red)"':''}">\${s.time}</div>
      <div class="tl-dot \${s.status==='live'?'live':''}"></div>
      <div class="tl-info">
        <div class="tl-show \${s.status==='live'?'style="color:var(--red)"':''}">\${s.show}\${s.status==='live'?' <strong>← AGORA</strong>':''}</div>
...
function renderSchedule(day){
  ...
  tbody.innerHTML = data.map((s,i)=>{
    ...
    const genreBadge = {Sertanejo:'b-acc','Pop / R&B':'b-blue','Pop/R&B':'b-blue','Pop / Rock':'b-blue','Rock/Pop':'b-gray',Gospel:'b-purple',Rock:'b-gray',Variado:'b-gray'}[s.genre]||'b-gray';
