...
import { login, logout } from '@/app/vale-indica/actions';
  ...
  <aside class="painel-sidebar" id="painelSidebar">
    ...
    <div class="ps-footer">
      <div class="ps-plan">
       ...
       <form>
        <button formAction={logout} class="ps-logout">
...
<script data-cfasync="false" src="/cdn-cgi/l/email-protection.min.js"></script><script>
/* ═══════════════════════════════════════════════════
