    ...
    <div className="animate-in fade-in duration-500">
      <div className="ph">
        <div className="ph-left">
          ...
          <p>Tudo que aconteceu na Dresbach Records</p>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 admin-card">
          <div className="card-title"><Clock className="text-admin-gold" /> Atividades Recentes</div>
        ...
        <div className="space-y-6">
          <div className="admin-card">
            <h3 className="text-lg font-black italic uppercase tracking-tighter mb-6">Resumo da Semana</h3>
            {[
              ['Faixas enviadas','4'],['Distribuições','2'],['Contratos assinados','1'],['Royalties processados','$3,240'],['Novos streams','48,200']
            ].map(([l,v], i) => (
              <div key={i} className="flex justify-between py-3 border-b border-admin-surface2 last:border-0 text-xs font-bold uppercase">
