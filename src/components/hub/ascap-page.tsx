  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          <h1 className="text-4xl font-black italic uppercase tracking-tighter text-white leading-none">Minha Filiação ASCAP</h1>
        ...
        <div className={`px-4 py-2 rounded-full border text-[10px] font-black uppercase tracking-widest flex items-center gap-2 ${
          isPending ? "bg-primary/10 border-primary/20 text-primary" : "bg-accent/10 border-accent/20 text-accent"
        }`}>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-zinc-950 border border-white/5 rounded-3xl p-8 space-y-8">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-primary/10 rounded-xl text-primary"><ShieldCheck className="h-6 w-6" /></div>
              <h3 className="text-lg font-black italic uppercase tracking-tighter text-white">Status da Identidade de Criador</h3>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-6 bg-white/5 border border-white/10 rounded-2xl space-y-4">
                 <p className="text-[10px] font-black uppercase text-zinc-600">Seu Código IPI / CAE</p>
              ...
              <div className="p-6 bg-white/5 border border-white/10 rounded-2xl space-y-4">
                 <p className="text-[10px] font-black uppercase text-zinc-600">Papel na ASCAP</p>
          ...
          <div className="bg-zinc-950 border border-white/5 rounded-3xl p-8">
            <h3 className="text-lg font-black italic uppercase tracking-tighter text-white mb-8">Vantagens da Filiação Global</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {benefits.map((b, i) => (
                <div key={i} className="p-6 bg-white/5 border border-white/5 rounded-2xl group hover:border-primary/40 transition-all">
                  <div className="p-3 w-fit bg-black rounded-xl text-primary mb-4 group-hover:scale-110 transition-transform">
                    {b.ic}
                  </div>
                  <h4 className="text-sm font-black uppercase text-white mb-2">{b.t}</h4>
                  <p className="text-[11px] text-zinc-500 leading-relaxed font-medium">{b.d}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="space-y-6">
          <div className="bg-zinc-950 border border-white/5 rounded-3xl p-8 space-y-6">
            <h3 className="text-xs font-black uppercase tracking-widest text-zinc-500 flex items-center gap-2">
              <Info className="h-4 w-4" /> Perguntas Frequentes
            </h3>
            <div className="space-y-6">
              <div className="space-y-2">
                <p className="text-[10px] font-black uppercase text-white">Por que 4 semanas?</p>
                <p className="text-[11px] text-zinc-500 leading-relaxed">A ASCAP realiza uma verificação de identidade e duplicidade de IPI em bases de dados mundiais (CISAC) antes de emitir seu número oficial.</p>
              </div>
              <div className="space-y-2">
                <p className="text-[10px] font-black uppercase text-white">Já tenho IPI, o que faço?</p>
                <p className="text-[11px] text-zinc-500 leading-relaxed">Nossa equipe irá detectar automaticamente e vincular sua conta existente à gestão DMG para coleta otimizada.</p>
              </div>
              <div className="space-y-2">
                <p className="text-[10px] font-black uppercase text-white">Onde vejo minhas obras?</p>
                <p className="text-[11px] text-zinc-500 leading-relaxed">No menu "Meu Catálogo". Cada obra aprovada pela DMG é submetida em tempo real para o registro ISWC global da ASCAP.</p>
              </div>
            </div>
          </div>

          <Button asChild className="w-full h-16 bg-white text-black font-black uppercase rounded-2xl hover:bg-primary hover:text-white transition-all">
