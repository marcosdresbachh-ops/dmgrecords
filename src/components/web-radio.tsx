        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="space-y-12">
            ...
            <div className="space-y-8">
              ...
              <div className="p-8 bg-zinc-50 border-l-[12px] border-primary italic text-lg text-zinc-600 leading-relaxed font-bold uppercase shadow-inner rounded-r-3xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 pt-8">
              {FEATURES.map((item, i) => (
                <div key={i} className="space-y-4">
                  <div className="p-4 bg-zinc-50 inline-block shadow-sm border border-zinc-100 rounded-2xl">{item.icon}</div>
            ...
            <div className="pt-10 flex flex-wrap gap-6">
              <Button asChild className="bg-zinc-900 hover:bg-primary text-white font-black h-20 px-12 tracking-tighter text-xl transition-all shadow-xl">
                <a href="#contato">ENVIAR MINHA MÚSICA</a>
              </Button>

              <Dialog>
                <DialogTrigger asChild>
                  <Button variant="outline" className="border-zinc-900 text-zinc-900 hover:bg-zinc-900 hover:text-white font-black h-20 px-12 tracking-tighter text-xl shadow-sm transition-all">
                    <Download className="mr-3 h-7 w-7" /> TERMO DE CONCESSÃO
                  </Button>
                </DialogTrigger>
                <DialogContent className="bg-white border-zinc-200 text-zinc-900 rounded-3xl max-w-md shadow-2xl p-10">
                  ...
                  <div className="grid gap-6 py-10">
                    <Button asChild className="w-full h-20 bg-zinc-900 text-white font-black uppercase tracking-tighter hover:bg-primary shadow-lg text-lg italic transition-all">
                    ...
                    <Button asChild variant="outline" className="w-full h-20 border-zinc-200 text-zinc-900 font-black uppercase tracking-tighter hover:bg-zinc-50 text-lg italic transition-all">
                  ...
                  <div className="p-6 bg-zinc-50 border border-zinc-100 space-y-4 shadow-inner rounded-2xl">
          ...
          <div className="relative">
            ...
            <div className="relative z-10 aspect-square bg-white border border-zinc-100 flex flex-col items-center justify-center p-16 text-center group shadow-2xl rounded-[40px]">
