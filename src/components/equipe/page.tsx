        ...
        <>
            ...
            <section className="sec">
                <div className="sec-inner">
                    ...
                    <div className="fi mt-14 rounded-lg border border-primary/20 bg-primary/10 px-8 py-9 text-center">
                        <h3 className="mb-2.5 font-['Playfair_Display',serif] text-xl font-black">Quer fazer parte da nossa equipe?</h3>
                        <p className="mb-5 text-[.9rem] text-muted-foreground">Estamos sempre em busca de talentos apaixonados por música e rádio. Envie seu portfólio!</p>
