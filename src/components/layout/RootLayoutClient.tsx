...
export function RootLayoutClient({ children }: { children: React.ReactNode }) {
  ...
  const isAppRoute = !pathname.startsWith('/admin') && !pathname.startsWith('/login-adm-const-adm-fm98,7') && !pathname.startsWith('/radio-indoor') && !pathname.startsWith('/vale-indica');
